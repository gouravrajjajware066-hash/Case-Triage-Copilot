...
Click OpenAI Config → Manage Records
...
Click New or edit an existing page
Search for "Case Triage Copilot" in the components panel
Drag it onto the page layout
Click Save → Activation → Assign as Org Default
Step 3: (Optional) Create Escalations Queue
For the Escalate action to reassign cases:
Go to Setup → Queues
Click New
Name: `Escalations`
Add Case to Supported Objects
Add queue members
Click Save
---
Usage
Quick Demo (2 minutes)
Open any Case record - The component loads automatically
...
Save to Log - Persists the triage session for audit
Test Scenarios
...
Go to Setup → Custom Metadata Types → OpenAI Config
Click Manage Records → Edit Default
...
Verify deployment: `sf project deploy start --source-dir force-app`
Add component to Lightning Record Page in App Builder
Ensure the page is activated
"Authentication failed"
Verify API key is correct
Check OpenAI account has available credits
Ensure Remote Site Setting for `api.openai.com` is active
---
Future Enhancements
